...
<main class='is-fullhd fill page-height parallax vegetable-bg'>
    <div class='container content box recipe-view'>
        <h1 class='title' id='recipe-name'>Lolah's Chicken Adobo</h1>
        <h5 class='subtitle' id='shef'>By foodelicious</h5>

        <div class='columns post-header'>
            <div class='column is-1 vote-header'>
                <i class='fas fa-chevron-up fa-2x logged-out'></i>
                <strong id='votes'>2</strong>
                <i class='fas fa-chevron-down fa-2x logged-out'></i>
            </div>
            ...
            <div class='column slider'>
                <!--                        Inner columns -->
                <div class='columns' id='food-pic' style='background: url("../public/img/foodelicious_chicken_adobo1.jpg")'>
                    ...
                    <div class='column center'>
                        <nav class='pagination is-centered is-rounded' role='navigation' aria-label='pagination'>
                            <ul class='pagination-list'>
                                <li><a class='pagination-link is-current' aria-label='image 1' aria-current='page'></a></li>
        ...
        <p class='content'>
            My Filipino Mom taught me how to make this traditional dish
            following the recipe her mother taught her.
            And though I've made a couple of changes, I guarantee they're Mom-approved.
            'Lolah' is 'Grandma' in the Philippines, in case you were wondering.
